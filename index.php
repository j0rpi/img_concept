...
.container {background: url('http://bibben.se/wp-content/uploads/2013/07/background.png'); width: 600px; height: 300px; border-radius: 8px 8px 8px 8px; border: 1px solid black;}
.login_container {width: 450px; height: 300px; border-radius: 8px 8px 8px 8px; border: 1px solid black}
</style>
<center>
<div align='center' class='container'>
<font style='font-size: 18px; font-family: Arial;'><img src='" . default_skin. "/" . site_logo . "'/><br><b>". site_name . "</b></font><br>
<br>
<br>
<br>
<br>
